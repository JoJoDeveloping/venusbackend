...
class STypeInstruction(
    ...
    opcode: Int,
    funct3: Int,
    store16: suspend (Simulator, Short, Short) -> Unit = { _, _, _ -> throw NotImplementedError("no rv16") },
    store32: suspend (Simulator, Int, Int) -> Unit,
    store64: suspend (Simulator, Long, Long) -> Unit = { _, _, _ -> throw NotImplementedError("no rv64") },
    store128: suspend (Simulator, QuadWord, QuadWord) -> Unit = { _, _, _ -> throw NotImplementedError("no rv128") }
) : Instruction(
        name = name,
