...
//    }
    ...
    init {
        ...
        setPC(linkedProgram.startPC ?: MemorySegments.TEXT_BEGIN) // TODO: check this ? linkedProgram.startPC ?: MemorySegments.TEXT_BEGIN
        ...
        fun step(): List<Diff> {
            ...
            try {
                when (state.registerWidth) {
                    16 -> {
                        Instruction[mcode].impl16(mcode, this)
                    }
                    32 -> {
                        Instruction[mcode].impl32(mcode, this)
                    }
                    64 -> {
                        Instruction[mcode].impl64(mcode, this)
                    }
                    128 -> {
                        Instruction[mcode].impl128(mcode, this)
                    }
                    else -> {
                        throw SimulatorError("Unsupported register width!")
                    }
                }
